...
```javascript
import gamma from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-gamma@v0.0.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-array-gamma/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/random-array-gamma/actions/workflows/test.yml?query=branch:v0.0.1
